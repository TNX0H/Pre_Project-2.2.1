...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Car car1 = new Car("Corvet", 9765);
      Car car2 = new Car("Babaha", 2479);
      Car car3 = new Car("Matilda", 854);
      Car car4 = new Car("Yaga", 2990);
      ...
      System.out.println(userService.getUserByCar("Corvet", 9765));
